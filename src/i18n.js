...
const en = {
    ...
    msg_btn_title: 'IF Imgen: generate images for this message (again = regenerate all; Shift+click: remove images). Click an image to regenerate just that one.',
...
const vi = {
    ...
    msg_btn_title: 'IF Imgen: tạo ảnh cho tin nhắn này (bấm lại = tạo lại toàn bộ; Shift+click: xóa ảnh). Bấm vào một ảnh để tạo lại riêng ảnh đó.',
