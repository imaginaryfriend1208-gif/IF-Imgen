...
const en = {
    ...
    note_scene: 'One call per reply. Writes the scene document every prompt of the reply is translated from, and that the next reply’s planner reads again for continuity (location, layout, who is present, clothing with colours and state, expression, actions, pose).',
...
const vi = {
    ...
    note_scene: 'Gọi 1 lần mỗi reply. Viết scene document mà mọi prompt của reply được dịch từ đó, và planner của reply kế tiếp đọc lại để giữ mạch (địa điểm, bố cục, ai có mặt, trang phục với màu sắc và tình trạng, biểu cảm, hành động, tư thế).',
