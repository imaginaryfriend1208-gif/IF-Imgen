...
const en = {
    ...
    note_behaviour: 'The reply is read as numbered paragraphs and each image is placed right after the paragraph it illustrates. Context messages = earlier chat text given to the scene planner; Previous scene documents = how many earlier replies’ scene documents it re-reads for continuity.',
...
const vi = {
    ...
    note_behaviour: 'Câu trả lời được đọc theo từng đoạn có đánh số và mỗi ảnh được chèn ngay sau đoạn mà nó minh họa. Số tin nhắn ngữ cảnh = phần chat trước đó đưa cho scene planner; Số scene document trước đọc lại = đọc lại scene document của bao nhiêu reply trước để giữ mạch.',
