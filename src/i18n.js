...
const en = {
    ...
    fl_title: 'IF Imgen quick actions', fl_regen: 'Regen last reply', fl_regen_sub: 'redraw every image of the last reply (same scenes, new refine)',
    fl_generate: 'Generate for last reply', fl_generate_sub: 'plan again from the text (replaces the images)', fl_cancel: 'Cancel {n} running job(s)',
    fl_gallery: 'Gallery', fl_settings: 'Settings', fl_fold: 'Collapse images', fl_unfold: 'Expand images', fl_drag: 'drag the button to move it',
    ...
    fl_style_saved: 'Saved "{name}".', fl_style_deleted: 'Deleted.', fl_style_name_req: 'Name is required.', fl_style_now_default: '"{name}" is now the default style.',
...
const vi = {
    ...
    fl_title: 'IF Imgen - thao tác nhanh', fl_regen: 'Regen reply cuối', fl_regen_sub: 'vẽ lại toàn bộ ảnh của reply cuối (giữ cảnh, refine mới)',
    fl_generate: 'Tạo ảnh cho reply cuối', fl_generate_sub: 'planner chọn lại từ text (thay ảnh cũ)', fl_cancel: 'Hủy {n} job đang chạy',
    fl_gallery: 'Thư viện', fl_settings: 'Cài đặt', fl_fold: 'Thu gọn ảnh', fl_unfold: 'Mở rộng ảnh', fl_drag: 'kéo nút để di chuyển',
    ...
    fl_style_saved: 'Đã lưu "{name}".', fl_style_deleted: 'Đã xóa.', fl_style_name_req: 'Cần nhập tên.', fl_style_now_default: '"{name}" giờ là style mặc định.',
