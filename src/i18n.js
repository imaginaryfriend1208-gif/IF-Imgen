...
const en = {
    ...
    lbl_use_workflow: 'ComfyUI workflow mode (send my own workflow to ComfyUI at this URL instead of A1111 txt2img)',
    lbl_size: 'Size preset', opt_size_custom: 'Custom (type width / height below)',
...
const vi = {
    ...
    lbl_use_workflow: 'Chế độ workflow ComfyUI (gửi workflow của mình tới ComfyUI ở URL này thay vì txt2img kiểu A1111)',
    lbl_size: 'Kích cỡ có sẵn', opt_size_custom: 'Tùy chỉnh (gõ rộng / cao bên dưới)',
