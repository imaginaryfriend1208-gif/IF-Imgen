...
const en = {
    ...
    fl_title: 'IF Imgen quick actions', fl_drag: 'drag the button to move', fl_regen: 'Regen last reply', fl_regen_sub: 'redraw all images (same scenes, new refine)',
    fl_generate: 'Generate for last reply', fl_generate_sub: 'plan again from the text - replaces the images', fl_cancel: 'Cancel running jobs',
    fl_gallery: 'Gallery', fl_settings: 'Settings', fl_collapse: 'Fold / unfold', fl_no_reply: 'No character reply to illustrate.', gen_bar: 'IF Imgen: generating images…',
...
const vi = {
    ...
    lbl_floater: 'Nút thao tác nhanh nổi (regen đầu tiên) + thanh tiến trình trên reply đang được vẽ',
    fl_title: 'IF Imgen - thao tác nhanh', fl_drag: 'kéo nút để di chuyển', fl_regen: 'Regen reply cuối', fl_regen_sub: 'vẽ lại toàn bộ ảnh (giữ cảnh, refine mới)',
    fl_generate: 'Tạo ảnh cho reply cuối', fl_generate_sub: 'planner chạy lại từ text - thay toàn bộ ảnh', fl_cancel: 'Hủy job đang chạy',
    fl_gallery: 'Gallery', fl_settings: 'Cài đặt', fl_collapse: 'Gập / mở ảnh', fl_no_reply: 'Chưa có reply của nhân vật để vẽ.', gen_bar: 'IF Imgen: đang tạo ảnh…',
