...
const en = {
    ...
    lbl_world: 'World', ph_world: 'apartment: small flat 8B, wooden table by the window, door on the left\nnpc_william: William, stocky man in his fifties, grey buzz cut, flannel shirt\nchinatown: narrow alley with red lanterns and wet asphalt', note_world: 'Places, side characters (NPCs) and recurring items of this person\'s story, one per line as <b>key: description</b>. Same tokens as Details (<b>$keyword.key</b>) but kept apart so the look stays short. The scene writer may define new tokens at the top of a scene document (TOKENS:) - save the ones worth keeping here.',
...
const vi = {
    ...
    lbl_world: 'Thế giới', ph_world: 'apartment: căn hộ nhỏ 8B, bàn gỗ cạnh cửa sổ, cửa ra vào bên trái\nnpc_william: William, đàn ông ngoài năm mươi, dáng chắc, tóc húi cua bạc, áo flannel\nchinatown: hẻm hẹp treo lồng đèn đỏ, mặt đường ướt', note_world: 'Địa điểm, nhân vật phụ (NPC) và vật dụng hay lặp lại trong truyện của người này, mỗi dòng <b>key: mô tả</b>. Token dùng giống Chi tiết (<b>$keyword.key</b>) nhưng tách riêng để phần ngoại hình gọn. Bước viết scene document có thể tự định nghĩa token mới ở đầu (TOKENS:) - token nào đáng giữ thì lưu vào đây.',
