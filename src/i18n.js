...
const en = {
    ...
    btn_profile_gen: 'Generate profile image', btn_profile_regen: 'Regenerate', btn_profile_cancel: 'Cancel', btn_profile_edit: 'Edit prompt & generate', btn_profile_view: 'Open image', btn_profile_delete: 'Delete this version',
    ...
    vw_edit: 'Edit & regenerate', vw_delete: 'Delete image', vw_jump: 'Go to message', vw_open: 'Open file', vw_close: 'Close', vw_prev: 'Previous', vw_next: 'Next',
...
const vi = {
    ...
    btn_profile_gen: 'Tạo ảnh đại diện', btn_profile_regen: 'Tạo lại', btn_profile_cancel: 'Hủy', btn_profile_edit: 'Sửa prompt & tạo', btn_profile_view: 'Mở ảnh', btn_profile_delete: 'Xóa phiên bản này',
    ...
    vw_edit: 'Sửa & vẽ lại', vw_delete: 'Xóa ảnh', vw_jump: 'Tới tin nhắn', vw_open: 'Mở file', vw_close: 'Đóng', vw_prev: 'Trước', vw_next: 'Sau',
