...
const en = {
    ...
    fl_title: 'IF Image Quick Actions', fl_regen: 'Regen last reply', fl_regen_sub: 'redraw every image of the last reply (same scenes, new refine)',
...
const vi = {
    ...
    fl_title: 'IF Image Quick Actions', fl_regen: 'Regen reply cuối', fl_regen_sub: 'vẽ lại toàn bộ ảnh của reply cuối (giữ cảnh, refine mới)',
